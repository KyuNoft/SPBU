...
<fieldset>
<legend>List Data BBM</legend>
<table align="center" border="1">
<tr>
	<th width="100">No BBM</th>
	<th width="100">Nama BBM</th>
...
?>
<tr>
	<td align="center"><?php echo $row->no_bbm;?></td>
	<td align="center"><?php echo $row->nama_bbm;?></td>
	<td align="center"><?php echo "Rp.". number_format("".$row->harga_bbm, 0, ",", ".");?></td>
	<td align="center"><?php echo $row->stok;?> Liter</td>
	<td align="center">
		<a href="update_bbm/<?php echo $row->no_bbm; ?>">Ubah</a>
	</td>
	<td align="center">
		<a href="delete_bbm/<?php echo $row->no_bbm; ?>">Hapus</a>
	</td>
</tr>
<?php
}
