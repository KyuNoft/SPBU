...
<body bgcolor="aqua">
	<fieldset class="bbm" align="center">
<legend>Penjualan PerShift</legend>
<p><strong>Tambah Data</strong></p>

<form action="insert_penjualan_pershift" method="post">
	No Nota :
	<input type="text" name="no_nota" maxlength="10" value="<?php echo $id ?>"><br/><br/>

	Tanggal Nota:
	<input type="date" name="tgl_nota"><br/><br/>
